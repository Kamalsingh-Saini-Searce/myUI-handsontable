			...
			var parseAutocomplete = function(scope, column, uiDatagrid) {
				...
				column.source = function(query, process) {
					if (angular.isArray(column.src)) {
						...
						$http({
							method: 'GET',
							url: column.src.indexOf('/api/') != -1 ? column.src : '/api/suggestion?q=' + query + '&responseType=array&pageLimit=100&page=1&selected=&suggestionFor=' + column.src + dependents
						}).
